...
export const AUTO_MODE_HOLD_DURATION = 2500;
...
export const ENEMY_VARIANTS: readonly EnemyVariant[] = [
  { name: 'スライム', shape: 'slime', bodyColor: 0x57cc99, headColor: 0x2a9d8f, attackPower: 10 },
  { name: 'ゴブリン', shape: 'goblin', bodyColor: 0xe76f51, headColor: 0x6d597a, attackPower: 20 },
  { name: 'ゴーレム', shape: 'golem', bodyColor: 0x8d99ae, headColor: 0x495057, attackPower: 30 },
];
...
export const WEAPONS: readonly Weapon[] = [
  ...
  { name: '鉄の剣', attackPower: 20, price: 300 },
  { name: '鋼の剣', attackPower: 40, price: 500 },
  { name: '炎の剣', attackPower: 60, price: 1000 },
  { name: '雷鳴の剣', attackPower: 80, price: 1500 },
  { name: '聖剣エターナル', attackPower: 100, price: 2000 },
];