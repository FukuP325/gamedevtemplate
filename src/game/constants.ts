...
export type EnemyVariant = {
  ...
  attackPower: number;
  reward: number;
  attackInterval: number; // ★ ここを追加します
};

export const ENEMY_VARIANTS: readonly EnemyVariant[] = [
  { name: 'スライム', shape: 'slime', bodyColor: 0x57cc99, headColor: 0x2a9d8f, attackPower: 3, reward: 50, attackInterval: 1000 }, // ★追加
  { name: 'ゴブリン', shape: 'goblin', bodyColor: 0xe76f51, headColor: 0x6d597a, attackPower: 6, reward: 100, attackInterval: 1500 }, // ★追加
  { name: 'ゴーレム', shape: 'golem', bodyColor: 0x8d99ae, headColor: 0x495057, attackPower: 9, reward: 200, attackInterval: 2000 }, // ★追加
];
